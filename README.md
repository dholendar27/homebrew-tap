...
```bash
brew install dholendar27/tap/hora
```

Alternatively, you can add this tap to your Homebrew installation and then install the application:

```bash
# Tap the repository
brew tap dholendar27/tap
